...
export default function Portfolio() {
  ...
  return (
    <div className="relative min-h-screen" data-testid="portfolio-root">
      ...
      {/* Top bar */}
      <header
        className="sticky top-0 z-40 hairline-b px-6 sm:px-10 lg:px-16 pt-4 pb-3 flex items-center justify-between"
        style={{ background: "rgba(250, 249, 246, 0.82)", backdropFilter: "blur(14px)", WebkitBackdropFilter: "blur(14px)" }}
        data-testid="top-bar"
      >
        <div className="flex items-center gap-3">
          <div className="h-7 w-7 rounded-full flex items-center justify-center shrink-0" style={{ background: "#1A1A1A" }}>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className="h-8 w-8 rounded-full hairline flex items-center justify-center text-neutral-700 hover:bg-neutral-900 hover:text-white transition md:hidden"
          >
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.nav
            ...
            className="sticky top-[60px] z-30 overflow-hidden md:hidden"
            style={{ background: "rgba(250, 249, 246, 0.96)", backdropFilter: "blur(14px)", WebkitBackdropFilter: "blur(14px)" }}
            data-testid="mobile-nav"
          >
            <div className="px-6 py-4 flex flex-col gap-4 font-mono text-[12px] text-neutral-700 uppercase tracking-widest hairline-t">
              <a href="#graph" onClick={() => setMenuOpen(false)} className="hover:text-black" data-reticle="hover">graph</a>
              <a href="#methodology" onClick={() => setMenuOpen(false)} className="hover:text-black" data-reticle="hover">methodology</a>
              <a href="#timeline" onClick={() => setMenuOpen(false)} className="hover:text-black" data-reticle="hover">timeline</a>
              <a href="#contact" onClick={() => setMenuOpen(false)} className="hover:text-black" data-reticle="hover">query</a>
            </div>
          </motion.nav>
        )}
      </AnimatePresence>
      ...
      {/* Hero / Dashboard */}
      <section id="graph" className="scroll-mt-24 px-6 sm:px-10 lg:px-16 pt-4 pb-10" data-testid="hero-dashboard">
      ...
      <div id="methodology" className="scroll-mt-20"><AnalysisPanels /></div>
      <div id="timeline" className="scroll-mt-20"><TimelineStrip /></div>
